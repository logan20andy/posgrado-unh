                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="page-title-heading">
                            <h2 class="title">Presentación UPG</h2>
                        </div>
                        <div class="breadcrumb-wrapper">
                            <span>
                                <i class="ti ti-home"></i>
                                <a title="Homepage" href="index.php">Inicio</a>
                            </span>
                            <span>Presentación UPG</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mt_5 pb-55 res-991-pb-40">
                            <!-- <h4 class="font-weight-600">Implementing High Technology Solutions to<br>Transform Your Business.</h4>
                            <div class="pb-5 pt-5 res-991-p-0">
                                <p>Uniaro University was established by J.H Merthon in 1920 for the public benefit. Afterwards, it is recognized globally. Throughout our great history, Merthon has offered access to a wide range of academic opportunities.</p>
                            </div> -->
                                ...
                                <div class="featured-content pl-30">
                                    <div class="featured-title">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <h3 class="mb-0 font-weight-600 fs-22"> Dr. Jaime Antonio RUIZ BEJAR</h3>
                                        </div>
                                    </div>
